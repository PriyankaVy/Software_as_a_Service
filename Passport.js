...
var Passport = /** @class */ (function () {
    function Passport() {
        ...
        }, function (request, accessToken, refreshToken, profile, done) { return __awaiter(_this, void 0, void 0, function () {
            var existingUser, newUser, savedUser, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, User.findOne({ user_id: profile.id })];
                    case 1:
                    ...
                    case 2:
                        savedUser = _a.sent();
                        return [2 /*return*/, done(null, savedUser)];
                    case 3:
                        error_1 = _a.sent();
